...
{
  public class NTF_Notification :XPLiteObject
  {
    ...
    public int NotificationId
    {
      ...
      set
      {
        SetPropertyValue("NotificationId", ref _notificationId, value);
      }
    }
    ...
    public long ReplyId
    {
      ...
      set
      {
        SetPropertyValue("ReplyId", ref _replyId, value);
      }
    }
    ...
    public NTF_Type Type
    {
      ...
      set
      {
        SetPropertyValue("TypeId", ref _type, value);
      }
    }
    ...
    public NTF_TemplateType TemplateType
    {
      ...
      set
      {
        SetPropertyValue("TemplateTypeId", ref _templateType, value);
      }
    }
    ...
    public string Cc
    {
      ...
      set
      {
        SetPropertyValue("Cc", ref _cc, value);
      }
    }
    ...
    public string Bcc
    {
      ...
      set
      {
        SetPropertyValue("Bcc", ref _bcc, value);
      }
    }
    ...
    public NTF_Notification() : base() { }
    public NTF_Notification(Session session) : base(session) { }
