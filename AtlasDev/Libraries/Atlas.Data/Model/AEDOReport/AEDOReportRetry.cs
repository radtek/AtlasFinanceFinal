...
{
  public class AEDOReportRetry : XPBaseObject
  {
    public struct ReportRetryKey
    {
    ...
    public AEDOReportRetry() : base() { }
    public AEDOReportRetry(Session session) : base(session) { }

    [Key, Persistent]
    public ReportRetryKey ReportRetry;
