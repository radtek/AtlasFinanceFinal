...
{
  public class AEDOReportNewTransaction : XPBaseObject
  {
    public struct ReportNewTransactionKey
    {
    ...
    public AEDOReportNewTransaction() : base() { }
    public AEDOReportNewTransaction(Session session) : base(session) { }

    [Key, Persistent]
    public ReportNewTransactionKey ReportNewTransaction;
