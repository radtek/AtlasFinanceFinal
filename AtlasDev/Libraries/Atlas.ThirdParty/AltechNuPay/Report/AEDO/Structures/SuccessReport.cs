...
namespace Atlas.ThirdParty.AltechNuPay.Report.AEDO
{
    public class SuccessReport
    {
        ...
        public SuccessReport(XElement item)
        {
            ...
            aedoReport.ReportSuccess.SuccessDT = DateTime.ParseExact(item.Element("success_date").Value + " " + item.Element("success_time").Value, "yyyyMMdd HH:mm:ss", CultureInfo.InvariantCulture);
