...
namespace Atlas.ThirdParty.AltechNuPay.Report.AEDO
{
    public class FutureReport
    {
        ...
        public FutureReport(XElement item)
        {
            ...
            aedoReport.ReportFuture.SubmitDT = DateTime.ParseExact(item.Element("submit_date").Value + " " + item.Element("submit_time").Value, "yyyyMMdd HH:mm:ss", CultureInfo.InvariantCulture);
