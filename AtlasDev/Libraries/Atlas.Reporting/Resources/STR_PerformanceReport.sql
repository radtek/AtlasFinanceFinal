SELECT 	BRN."Region" AS "RegionId",
	...
	COUNT(DISTINCT 
		CASE 
			WHEN CMT."CommentGroupId" = 19 THEN CSE."CaseId"
			ELSE NULL
		END) AS "ForceClosedCases",
	COUNT(DISTINCT 
		CASE 
...
LEFT JOIN "STR_Comment" CMT ON CST."CompleteCommentId" = CMT."CommentId"
...
GROUP BY CSE."BranchId", CPY."Name", SBC."CategoryId", CTG."Description", SBC."SubCategoryId", SBC."Description", BRN."Region",	RGN."Description" 
