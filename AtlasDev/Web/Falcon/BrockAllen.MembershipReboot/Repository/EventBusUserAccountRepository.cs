...
namespace BrockAllen.MembershipReboot
{
        ...
        where TAccount : UserAccount
    {
        ...
        public System.Collections.Generic.IList<TAccount> GetAll()
        {
          return inner.GetAll();
        }

        public System.Collections.Generic.IList<TAccount> GetNotVerifiedAccounts(string tenant)
        {
          return inner.GetNotVerifiedAccounts(tenant);
        }
