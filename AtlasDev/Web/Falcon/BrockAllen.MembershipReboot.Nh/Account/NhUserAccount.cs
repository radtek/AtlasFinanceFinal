namespace BrockAllen.MembershipReboot.Nh
{
    ...
    public class NhUserAccount : UserAccount
    {
        ...
        {
            this.ClaimsCollection = new List<NhUserClaim>();
            this.LinkedAccountsCollection = new List<NhLinkedAccount>();
            this.LinkedAccountClaimsCollection = new List<NhLinkedAccountClaim>();
            this.CertificatesCollection = new List<NhUserCertificate>();
            this.TwoFactorAuthTokensCollection = new List<NhTwoFactorAuthToken>();
            this.PasswordResetSecretsCollection = new List<NhPasswordResetSecret>();
        }
