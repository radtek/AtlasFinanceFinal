        ...
        _Axis.prototype = {
            ...
            _setTickOffset: function() {
                var options = this._options,
                    ...
                    offset = discreteAxisDivisionMode !== "crossLabels" || !discreteAxisDivisionMode;
                this._tickOffset = options.isHorizontal ? +offset : -offset
            },
    ...
    (function($, DX, undefined) {
        ...
        charts.BaseChart = core.BaseWidget.inherit({
            ...
            _renderElements: function(drawOptions) {
                ...
                that.layoutManager.placeDrawnElements(that._canvas);
                ...
                if (that._scrollBar) {
                    ...
                    if (argBusinessRange.categories && argBusinessRange.categories.length <= 1)
                        ...
                        zoomMinArg = _isDefined(that._zoomMinArg) ? that._zoomMinArg : argBusinessRange.minVisible;
                        zoomMaxArg = _isDefined(that._zoomMaxArg) ? that._zoomMaxArg : argBusinessRange.maxVisible
                    }
            ...
            _createTooltip: function() {
                ...
                if (that.tooltip)
                    ...
                    that.tooltip = core.CoreFactory.createTooltip(tooltipOptions, that._tooltipGroup, that._renderer);
            ...
            _dataIsReady: function() {
                return core.utils.notExistOrLoaded(this._dataSource)
            },
            ...
            render: function(renderOptions) {
                ...
                that.callBase.apply(that, arguments);
                delete that.__renderOptions;
                that.__forceRender = null;
                return that
            },
            getSize: function() {
                var canvas = this._canvas || {};
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxChart", viz.charts, charts.AdvancedChart.inherit({
            ...
            _checkPaneName: function(seriesTheme) {
                ...
                if ($.inArray(seriesTheme.pane, paneList) === -1)
                    return false;
                return true
            },
            ...
            _createScrollBar: function() {
                ...
                if (scrollBarOptions.visible)
                    that._scrollBar = (that._scrollBar || charts.factory.createScrollBar(that._renderer, that._scrollBarGroup)).update({
                        rotated: that._isRotated(),
