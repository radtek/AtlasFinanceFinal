...
namespace Atlas.Online.Web.Service.EasyNetQ
{
    internal class AtlasOnlineServiceBus : IServiceBus
    {
        ...
        public void Start()
        {
            ...
            var connectionString = string.Format("host={0};virtualHost={1};username={2};password={3};timeout=20;product=atlasonlinewebservice;requestedHeartbeat=120",
              address, virtualHost, userName, password);

            _log.Info("Starting Atlas Online Web Service message bus");
            try
            {
