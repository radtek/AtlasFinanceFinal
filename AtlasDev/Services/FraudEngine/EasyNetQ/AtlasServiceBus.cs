	...
	public class AtlasServiceBus : IServiceBus
	{
		...
		public void Start()
		{
			...
			var connectionString =
				$"host={address};virtualHost={virtualHost};username={userName};password={password};timeout=20;product=atlasfraudengine;requestedHeartbeat=120";

			_log.Info("Starting Atlas Fraud Engine message bus");
			try
			{
