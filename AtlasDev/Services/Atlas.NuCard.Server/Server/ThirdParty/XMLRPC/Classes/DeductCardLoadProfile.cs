...
{
  public struct DeductCardLoadProfile_Input
  {
    public const string MethodName = "DeductCardLoadProfile";
  ...
  public struct DeductCardLoadProfile_Output
  {
