        ...
        using (var unitOfWork = new UnitOfWork())
        {
          ...
          var machineEnabled = unitOfWork.Query<BIO_Setting>()
            .FirstOrDefault(s =>
              ...
              && s.Entity == machine.Id
              && s.SettingType == Enumerators.Biometric.SettingType.FPClientEnabled);
